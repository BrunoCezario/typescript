...
const geradorDeRelatorios = new GeraRelatorio(
  quadroColaboradores.colaboradores, calculaSalario
);
const pagamento = new Pagamento(calculaSalario);

const colaborador1 = new Colaborador("Flavio", Cargos.Estagiario);
const colaborador2 = new Colaborador("Jonas", Cargos.Junior);
const colaborador3 = new Colaborador("Omega", Cargos.Pleno);
